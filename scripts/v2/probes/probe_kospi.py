...
def build_result(root: Path, live: bool = False) -> dict[str, Any]:
    ...
    return {
        ...
        "technical_access": {"account_required": "yes", "api_key_required": "yes", "live_access_confirmed": False, "actual_resource_url": ENDPOINT, "access_notes": "Service Key is required. The attempted overseas individual registration path requires a Korean local mobile number; no key is stored in or requested by the repository."},
        ...
        "registration_attempt": {"status": "stopped", "blocker": "foreign_user_registration_requires_korean_mobile", "registration_completed": False, "service_key_issued": False, "api_requests_run": False, "raw_data_downloaded": False, "cost_incurred": False, "notes": "No virtual number, borrowed phone number, or other identity workaround was used."},
        "blocking_issues": ["foreign_user_registration_requires_korean_mobile", "No registration was completed and KOREA_DATA_GO_KR_SERVICE_KEY was not issued or configured.", "This is not a paid-access, API-quality, or licence-failure finding.", "KRX third-party redistribution rights remain unresolved at the public-contract level."],
