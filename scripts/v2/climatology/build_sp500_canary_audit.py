...
def build(root: Path | None = None) -> dict[str, Any]:
    ...
    audit = {
        ...
        "request_identity": {
            "request_identity_status": "corrected",
            "request_identity_contract_version": REQUEST_IDENTITY_CONTRACT_VERSION,
            "legacy_final_request_id": LEGACY_FINAL_REQUEST_ID,
            "corrected_final_request_id": request_id,
            "timezone_canary_hash": EXPECTED_TIMEZONE_CANARY_HASH,
            "request_dates_count": 90,
            "request_times": EXPECTED_TIME_UNION,
            "binds_exact_transport_dates_times": True,
            "canonicalization": "dates/times/variable/product_type sorted; area positional N/W/S/E; dict keys sorted",
        },
        "anchor": {
        ...
        "timezone": {"provider": anchor_payload()["timezone"]},
        "planning": {
        ...
        "derived": {
            ...
            "expected_sha256": "e9b32bbcd233e1a6448cceb11d9114ef08f6ce8de0c8aca9d33cac7212d9499f",
        },
        "oracle": {
        ...
        "idempotency": {
            ...
            "corrected_request_pre_network_skip": True,
            "corrected_request_resolves_via": "request_binding_sidecar",
        },
        "request_identity_repair": {
            "stage": "5E-3A-R1",
            "repair_network_calls": 0,
            "raw_immutable": True,
        ...
        "network_budget": {
            ...
            "original_stage_retrieve_calls": 1,
            "r1_retrieve_calls": 0,
            "total_lifetime_retrieve_calls_for_raw": 1,
