...
| KOSPI | not fetched | not fetched | not fetched | unverified | Official catalogue/contract verified; Service Key is absent, so payload, fields, series identity, boundaries, and quality are intentionally unverified. |
